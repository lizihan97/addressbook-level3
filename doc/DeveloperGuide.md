...
`* * *` | user | edit an existing person | update contact information without deleting or adding
`* * *` | user | view a list of people in name ascending/descending order | find person's name if forget spelling
